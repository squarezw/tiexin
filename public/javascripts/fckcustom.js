...
FCKConfig.Plugins.Add( 'hotspot') ;
FCKConfig.Plugins.Add( 'quickUpload') ;

// ONLY CHANGE BELOW HERE
FCKConfig.SkinPath = FCKConfig.BasePath + 'skins/silver/';

FCKConfig.ToolbarSets["Simple"] = [
	['hotspot','-','quickUpload','-','Templates'],
...
FCKConfig.ToolbarSets["Simple2"] = [
	['hotspot','quickUpload', '-', 'Cut','Copy','Paste','PasteWord','-','Print'],
