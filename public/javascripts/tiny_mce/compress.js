tinyMCE.init({
        ...
        theme_advanced_buttons2:"undo,redo,cut,copy,paste,separator,justifyleft,justifycenter,justifyright,separator,outdent,indent,separator,link,unlink,square,media,emotions,table,separator,quote,code,separator,fullscreen",
